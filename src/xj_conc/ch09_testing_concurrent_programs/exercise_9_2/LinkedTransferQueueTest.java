package xj_conc.ch09_testing_concurrent_programs.exercise_9_2;
...
public class LinkedTransferQueueTest {
    ...
    public void testOurLinkedTransferQueue() throws Exception {
        checkCollection(new LinkedTransferQueue<>()); // our LTQ from 1.8.0_45
    }

    @Test
    public void testRealLinkedTransferQueue() throws Exception {
        checkCollection(new java.util.concurrent.LinkedTransferQueue<>()); // real LTQ
    }
