package xj_conc.ch15_optimizations.exercise_15_2_1;
...
// 1. run with -showversion -Xmx500m -Xloggc:server.vgc
// 3. run with -showversion -Xmx500m -Xcomp -Xloggc:server_comp.vgc
// 5. run with -showversion -Xmx500m -Xint -Xloggc:server_int.vgc
